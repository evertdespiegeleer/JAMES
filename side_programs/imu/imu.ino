...
double a_angles[3] = {0,0,0}; //{pitch, roll,yaw}
...
void readOrientation() {
  ...
  a_angles[2] = compass.heading()*DEG_TO_RAD;
  ...
  f_angles[2] = 0.99 * (f_angles[2] - (gyro.g.z - g_zero[1]) * dt * 0.001 * gyroToRasPSFactor) + 0.01*compass.heading()*DEG_TO_RAD;
}
...
void loop() {
  ...
  Serial.print("");Serial.print(f_angles[1]);Serial.print(" ");
